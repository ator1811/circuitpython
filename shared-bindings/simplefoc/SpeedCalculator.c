...
//|
//|     Works with CircuitPython's rotaryio.IncrementalEncoder."""
//|
//|     def __init__(self, pulses_per_revolution: int, min_dt: float = 0.001) -> None:
//|         """Create a speed calculator
//|
//|         :param int pulses_per_revolution: Encoder pulses per revolution
...
mp_obj_t simplefoc_speedcalculator_make_new(const mp_obj_type_t *type,
    ...
    simplefoc_speedcalculator_obj_t *self = mp_obj_malloc(simplefoc_speedcalculator_obj_t, &simplefoc_speedcalculator_type);
